...
// 시간 보정용 변수 (노래 건너뛰기 변수는 삭제됨)
let jumpStartTime = 0;       // 게임이 시작된 시점의 실제 컴퓨터 시간 기록
...
function draw() {
  ...
  // ============================================
  // [수정] 오디오 시간과 실제 흘러간 정밀 시간 보정 계산 (targetStartTimeSec 제거 반영)
  // ============================================
  let audioTime = bgm.currentTime() * 1000;
  let calculatedTime = millis() - jumpStartTime;
